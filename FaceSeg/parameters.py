...
def get_parameters():
    ...
    parser.add_argument('--arch', type=str, default="EHANet18")
    ...
    parser.add_argument('--img_path', type=str,
                        default='./Dataset/CelebAMask-HQ/train_img')
    parser.add_argument('--label_path', type=str,
                        default='./Dataset/CelebAMask-HQ/train_label')
    parser.add_argument('--model_save_path', type=str, default='./models')
    parser.add_argument('--sample_path', type=str, default='./samples')
    parser.add_argument('--val_img_path', type=str,
                        default='./Dataset/CelebAMask-HQ/val_img')
    parser.add_argument('--val_label_path', type=str,
                        default='./Dataset/CelebAMask-HQ/val_label')
    parser.add_argument('--test_image_path', type=str,
                        default='./Dataset/CelebAMask-HQ/test_img')
    parser.add_argument('--test_label_path', type=str,
                        default='./Dataset/CelebAMask-HQ/test_label')
