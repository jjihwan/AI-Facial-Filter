...
class RandomAffine(object):
    ...
    def __call__(self, img, mask):
        ...
        rotate_degree = random.random() * 2 * self.degrees - self.degrees
        x_offset = int(2 * (random.random() - 0.5) * self.translate[0])
        y_offset = int(2 * (random.random() - 0.5) * self.translate[1])
