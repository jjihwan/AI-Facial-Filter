...
def set_cor(mask):
    ...
    l_eye_xcor = np.arange(512).reshape((-1, 1)) * l_eye
    l_eye_ycor = np.arange(512).reshape((1, -1)) * l_eye
    r_eye_xcor = np.arange(512).reshape((-1, 1)) * r_eye
    r_eye_ycor = np.arange(512).reshape((1, -1)) * r_eye
    lips_xcor = np.arange(512).reshape((-1, 1)) * lips
    lips_ycor = np.arange(512).reshape((1, -1)) * lips
    nose_xcor = np.arange(512).reshape((-1, 1)) * nose
    nose_ycor = np.arange(512).reshape((1, -1)) * nose
    ...
    affined = 2*np.array([[110, 90], [110, 165], [197, 128], [143, 128]])
